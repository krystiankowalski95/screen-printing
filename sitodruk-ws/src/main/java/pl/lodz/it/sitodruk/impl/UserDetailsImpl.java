...
public class UserDetailsImpl implements UserDetails {
    ...
    public static UserDetailsImpl build(UserEntity user) {
        ...
        for (UserAccessLevelEntity userAccessLevelEntity : user.getUserAccessLevelsById()){
            if(userAccessLevelEntity.getActive()){
                authorities.add(new SimpleGrantedAuthority(userAccessLevelEntity.getAccessLevelName()));
            }
        }
